...
public class FeatureGenerator {
    ...
    static {
    // ten features in total for each example
	...
	while (scanner.hasNextLine()) {
	    ...
	    Instance instance = makeInstance(instances, line); // makeInstance for each line
	...
	String lastName = parts[2].toLowerCase();	// last name
	...
	// Add each feature 
	int first_name_len = firstName.length();
	int last_name_len = lastName.length();

	if(first_name_len < 5)	// First name
	{
